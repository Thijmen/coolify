...
class ExperimentalDeploymentJob implements ShouldBeEncrypted, ShouldQueue
{
    ...
    private function actionDeployPullRequest(): void
    {
        $this->context->switchToBuildServer();

        $pullRequestAction = new DeployPullRequestAction($this->context);
        $pullRequestAction->run();
    }
