...
it('should be able to deploy a Static project', function () {
    ...
    $domainNameInDocker = "http://static-testing.{$dockerHostIp}.sslip.io";

    $application = Application::factory()->create([
        'name' => 'Static Deployment',
        'fqdn' => "{$domainNameInDocker},http://static-testing.127.0.0.1.sslip.io",
    ...
    expect($content)
        ->toContain('Hello from index.html');
